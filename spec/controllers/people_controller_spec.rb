...
describe PeopleController do
  ...
  describe "named routing" do
    ...
    it "should route people_path() to /people" do
      ...
      people_path(:format => 'xml').should == "/people.xml"
      people_path(:format => 'json').should == "/people.json"
    end
    
    it "should route new_person_path() to /people/new" do
      new_person_path().should == "/people/new"
      new_person_path(:format => 'xml').should == "/people/new.xml"
      new_person_path(:format => 'json').should == "/people/new.json"
    end
    
    it "should route person_(:id => '1') to /people/1" do
      person_path(:id => '1').should == "/people/1"
      person_path(:id => '1', :format => 'xml').should == "/people/1.xml"
      person_path(:id => '1', :format => 'json').should == "/people/1.json"
    end
